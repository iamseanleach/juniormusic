    ...
    s.prototype = {
        ...
        onSongChange: function(t) {
            ...
            this.updatePrevNextButtons(); {
                var a = {
                    index: e,
                    title: this.playListObj.eq(e).find(".songTitle").text(),
                    artist: this.playListObj.eq(e).find(".artistName").text(),
                    albumCover: this.playListObj.eq(e).find(".songTitle").data().albumCover,
                    ele: this.playListObj.eq(e)
                };
                this.playListObj.eq(e).find("a").text(),
                this.playListObj.eq(e).find(".artistName").text()
            }
